...
int main(int argc, char** argv) {
	...
	addSource("gab1", "sources/gab1.mkv",
					"sources/gab1.mkv", 2.55*2/30, 1./2, 1./2);
	...
	for(int i=0;i<(int)notes.size();i++) {
		...
		switch(n.channel) {
			...
			case 1: src = getSource("gab1"); n.amplitudeDB -= 1; break;
			case 4: src = getSource("gab1"); n.amplitudeDB -= 5; break;
			case 5: src = getSource("gab1"); n.amplitudeDB -= 8; break;
			
			case 2: src = getSource("perc2"); n.amplitudeDB += 3; break;
			case 3: src = getSource("perc2"); n.amplitudeDB += 3; break;
			default: goto skip;
		}
		n.pitchSemitones -= 7;
